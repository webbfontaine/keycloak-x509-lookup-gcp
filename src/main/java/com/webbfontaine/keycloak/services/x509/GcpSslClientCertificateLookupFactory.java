...
public class GcpSslClientCertificateLookupFactory extends AbstractClientCertificateFromHttpHeadersLookupFactory {

    private static final String PROVIDER = "gcp";

    @Override
    public X509ClientCertificateLookup create(KeycloakSession session) {
        return new GcpSslClientCertificateLookup(sslClientCertHttpHeader,
